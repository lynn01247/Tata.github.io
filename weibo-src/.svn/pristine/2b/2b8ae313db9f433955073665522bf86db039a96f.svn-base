...
public class StringUtils {
     ...
     * @return
     */
    public static boolean checkWeiXinName(String weixin_name) {
        if (weixin_name.length() < 6) {
            ToastUtil.show(R.string.notice_weixin_lengthless);
            return false;
        }
        if (isChinese(weixin_name)) {
            ToastUtil.show(R.string.notice_weixin_no_chinese);
        }
        return true;
    }
     ...
     * @return
     */
    public static boolean isSensitive(String string) {
        if (string.contains("来搞")) {
            return true;
        }
        if (string.contains("管理")) {
            return true;
        }
        return false;
    }
