...
public class XListView extends ListView implements OnScrollListener {
    ...
    public void stopRefresh() {
        if (mPullRefreshing) {
            ...
            resetHeaderHeight();//reset header view's height.
        }
    }
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            ...
            default:
                mLastY = -1; // reset
                if (getFirstVisiblePosition() == 0) { // invoke refresh
                ...
                if (getLastVisiblePosition() == mTotalItemCount - 1) { // invoke load more.
    ...
    public void computeScroll() {
        if (mScroller.computeScrollOffset()) {
            ...
            //刷新界面:invalidate / postInvalidate，
