...
public class MoreActivity extends Activity {
    ...
    MySlipSwitch night_myslipswitch;
    @Bind(R.id.more_ll)
...
//    SlidingMenu mMenu;
    ...
    private void initView() {
        ...
        slipswitch_MSL.setSwitchState((Boolean) SharedPreferencesUtils.getParam(MoreActivity.this, Global.LOAD, false));
        slipswitch_MSL.setOnSwitchListener(new MySlipSwitch.OnSwitchListener() {
        ...
        night_myslipswitch.setImageResource(R.drawable.bkg_switch, R.drawable.bkg_switch, R.drawable.btn_slip);
        night_myslipswitch.setSwitchState((Boolean) SharedPreferencesUtils.getParam(MoreActivity.this, Global.LOAD, false));
        night_myslipswitch.setOnSwitchListener(new MySlipSwitch.OnSwitchListener() {
...
//    }
        ...
        gv_foot_menu.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                switch (position) {
                    case 0:// 获得我关注的数据
                        Toast.makeText(
                                MoreActivity.this, items[(int) (Math.random() * items.length)].toString(), Toast.LENGTH_LONG).show();
                        break;
                    case 1:
                        Toast.makeText(
                                MoreActivity.this, items[(int) (Math.random() * items.length)].toString(), Toast.LENGTH_LONG).show();
    ...
    public void onEventMainThread(FirstEvent event) {
        if ("true".equals(event.getMsg())) {
            more_ll.setBackgroundColor(getResources().getColor(R.color.black));
        } else {
            more_ll.setBackgroundColor(getResources().getColor(R.color.white));
        }
    }
